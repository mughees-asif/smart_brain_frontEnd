...
class Register extends React.Component {
  ...
  onSubmitSignIn = () => {
    fetch('https://peaceful-shelf-20406.herokuapp.com/register', {
      method: 'post',
      ...
      <article className="br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center">
        <main className="pa4 black-80">
          <div className="measure">
            <fieldset id="sign_up" className="ba b--transparent black ph0 mh0">
              <legend className="f1 fw6 white ph0 black mh0">Register</legend>
              <div className="mt3">
